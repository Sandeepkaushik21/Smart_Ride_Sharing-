...
const PassengerDashboard = () => {
  ...
  const handleConfirmBooking = async (rideId) => {
    ...
    try {
      ...
      await showError(error.response?.data?.message || 'Error booking ride');
    }
  };
  ...
  const handleCancelBooking = async (bookingId) => {
    ...
    try {
      ...
      await showError(error.response?.data?.message || 'Error cancelling booking');
    }
  };
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          ...
                          <div className="bg-gray-50 px-3 py-2 rounded-lg">
                            ...
                            <div className="font-semibold text-gray-900">{booking.ride?.time}</div>
                          </div>
                          <div className="bg-gray-50 px-3 py-2 rounded-lg">
                          ...
                          {booking.numberOfSeats > 1 && (
                            <div className="bg-gray-50 px-3 py-2 rounded-lg">
                              ...
                              <div className="font-semibold text-gray-900">{booking.numberOfSeats}</div>
                            </div>
                          )}
                        </div>
